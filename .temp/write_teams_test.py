test_content = """\"\"\"Tests for team and user management (Phase 3).\"\"\"
...
class TestTeamCRUD:
    \"\"\"Tests for team creation and management.\"\"\"
...
class TestUserCRUD:
    ...
    def test_get_team_members(self, team):
        ...
        # Admins should come first due to ORDER BY role, username
...
print(f"Written test_teams.py ({len(test_content)} bytes)")
